...
htmlhelp_basename = 'Bio2BELCTDdoc'
...
latex_documents = [
    (master_doc, 'Bio2BELCTD.tex', 'Bio2BEL CTD Documentation',
...
man_pages = [
    (master_doc, 'bio2belctd', 'Bio2BEL CTD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Bio2BELCTD', 'Bio2BEL CTD Documentation',
     author, 'Bio2BELCTD', 'Converts CTD to BEL.',
     'Miscellaneous'),
]
